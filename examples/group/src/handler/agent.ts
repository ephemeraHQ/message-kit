...
function generateSystemPrompt(context: HandlerContext) {
  ...
  If the user asks about performing an action and you can think of a command that would help, answer directly with the command and nothing else. Populate the command with the correct or random values. Always return commands with real values only, without property names or placeholders.\n
