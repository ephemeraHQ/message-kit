  ...
  "commands": [
    {
      ...
      "params": {
        "amount": {
          // Amount field has special treatment
...
_Note: The helper function is limited in terms of how parameters can be extracted. This is only one possible approach and we can think of AI approaches more suitable for multipurpose commands. In the scope of this repo here is the example parser._
