...
You can send text messages to the app and the app will parse the message and execute the command. This is useful for deep linking to a conversation or executing commands.
