...
Each app can have a `commands.ts` file that contains the availble commands for the users. The commands are defined as an array of objects with the following structure:
