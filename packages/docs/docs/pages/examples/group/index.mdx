...
This is a reference bot that will allow you to understand the potential and all of its features. Through many handlers you will be able to understand different use case:
...
- [Game](/examples/group/games): Handle frame games like `/game slot`, `/game wordle`
