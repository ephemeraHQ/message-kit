...
## [1.1.7-beta.18] - 2024-11-02

- **New Features**

  - Introduced new skills for handling group interactions, including `/id` for retrieving group ID.
  - Added a new section for "AI Skills" in the documentation, detailing a framework for building AI agents.
  - Enhanced skill execution with improved error handling and response structures.

- **Bug Fixes**

  - Resolved issues related to skill execution and improved logging for better error tracking.

- **Documentation**

  - Updated installation instructions and added more resources for users.
  - Enhanced clarity in documentation regarding skill processing and multi-line responses.
