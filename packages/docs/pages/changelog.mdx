...
- Introduced a new `xmtp` package for XMTP messaging

## Message Kit 1.5.0 deprecation

### 1.5.0

- Deprecated MessageKit framework & CLI in favor of a lower level SDK
- Introduced a new `xmtp` package for XMTP messaging
- Introduced a new `resolver` package for resolving identities to EVM addresses
- Deprecated `base-links` package for generating Coinbase usdc links

### 1.4.0

- **Rebranding**

  - Project renamed from "XMTP AI" to "Message Kit"
  - Updated documentation and references across the framework

- **Package Restructuring**

  - Introduced new `xmtp` package
  - Consolidated and simplified package structure

- **Documentation Updates**

  - Reorganized documentation sections
  - Updated links and navigation paths
  - Improved clarity of framework overview and concepts

- **Messaging Infrastructure**

  - Transitioned from V2 to V3 XMTP protocol
  - Simplified client initialization and message handling
  - Enhanced group messaging capabilities

- **Dependency Management**

  - Updated and streamlined external dependencies
  - Removed legacy code and version-specific implementations

- **Performance Improvements**

  - Optimized message parsing and routing
...
- **New Features**
  ...
  - Enhanced `base-links` functionality for simplified receipt generation and wallet interactions.
...
- **Chores**
  ...
  - Updated URL formats in the base-links documentation for receipts.
...
- **Documentation Updates**
  ...
  - Enhanced clarity and detail in XMTP, base-links, and WalletService documentation.
...
- **New Features**
  ...
  - Introduced a new `base-links` plugin for sending frames.
