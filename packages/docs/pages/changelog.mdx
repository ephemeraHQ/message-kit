...
- **New Features**
  ...
  - Enhanced documentation for various components, including new sections for USDC and toss management.
...
- **Bug Fixes**
  ...
  - Improved error handling and logging for wallet operations and toss management.
...
- Quickstarts section
  ...
  - [Definition](https://messagekit.ephemerahq.com/skills/definition): Define the skills
  ...
  - [Scenarios](https://messagekit.ephemerahq.com/skills/scenarios): For the agent to understand the context and perform skills autonomously.
