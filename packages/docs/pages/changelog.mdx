...
- Quickstarts section
  ...
  - [Definition](https://message-kit.org/skills/definition): Define the skills
  - [Parsing](https://message-kit.org/skills/parsing): From @base please let swap 1 eth to usdc to /swap 1 eth usdc
  - [Processing](https://message-kit.org/skills/processing): For an agent to process new lines
  - [Scenarios](https://message-kit.org/skills/scenarios): For the agent to understand the context and perform skills autonomously.
- [Reasoning](https://message-kit.org/skills/reasoning): For the agent to understand all context and perform skills autonomously.
