...
- **Bug Fixes**
  ...
  - Improved null safety checks throughout the application to prevent runtime errors.
...
- **New Features**
  ...
  - New `waas` skills for wallet management added.
...
- **Documentation**
  ...
  - Improved documentation on file structure, wallet service, and XMTPContext for better usability.
