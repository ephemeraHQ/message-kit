...
_Note: The [command helper](https://github.com/xmtp-labs/message-kit/blob/main/packages/message-kit/src/lib/helper.ts) is optional and has limitations in parameter extraction. Still, it's a good starting point. You could consider AI-driven methods that are more adaptable for various command._
