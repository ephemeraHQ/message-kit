...
Groups in XMTP enable communication among multiple participants. This guide covers creating groups, syncing states, managing metadata, and handling members.

For more details, see XMTP's [Group documentation](https://xmtp.org/docs/build/group-chat).
