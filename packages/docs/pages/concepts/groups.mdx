...
> Make sure you follow the [guidelines](/community/guidelines) for building responsible group agents on XMTP.
...
> For more reliable functions visit [Plugins](/community/plugins)
