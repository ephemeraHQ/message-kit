...
If the message starts with a `/` it is considered a skill. See more details in the [skills](/skills/definition) section.
...
An easier way to declare how to handle and respond to skills is to use handlers. Handlers help you orgaize the code being useful when you are managing multiple agents.
