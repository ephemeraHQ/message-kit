...
App messages a re messages that are sent when you send a reply to a message and are highlighted differently by the apps.
...
You can set an awaited handler to wait for a response from the user.
