...
// [!include ~/../../templates/ens/src/skills/register.ts]
```
...
```tsx [src/index.ts]
// [!include ~/../../templates/ens/src/index.ts:skills]
```
...
```tsx [src/index.ts]
// [!include ~/../../templates/ens/src/index.ts:run1]
// [!include ~/../../templates/ens/src/index.ts:run2]
```
