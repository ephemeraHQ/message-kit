...
_To learn more on how to define skills, go to [skills](/skills/definition) section_
...
```bash [.env]
KEY= # the private key of the agent wallet, like any normal wallet private key.
```
