...
- [`one-to-one`](/use-cases/one-to-one): A simple and powerful conversational app to manage subscriptions.
- [`group`](/use-cases/group): Group chat app example with all the features.
