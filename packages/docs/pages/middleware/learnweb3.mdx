...
[LearnWeb3](https://learnweb3.io/) is a platform that allows users to claim testnet tokens for different networks.

```jsx [lib/learnweb3.ts]
import axios from "axios";

export const BASE_TX_FRAME_URL = "https://web.message-kit.org";
