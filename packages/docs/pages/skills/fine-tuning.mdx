...
Fine tuning is a technique to improve the performance of a model on a specific tas just giving example responses.This technique can have the most important impact to improve the bot responses to specific use case and in general.
