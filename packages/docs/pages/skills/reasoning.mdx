...
- [Reasoning](/skills/reasoning): Smart agents with reasoning capabilities.
- [Fine Tuning](/skills/fine-tuning): Bot can handle fine tuned responses.
- [Processing](/skills/processing): Bot can handle multiple responses from the AI.
- [Parsing](/skills/parsing): Bot interprets user intent and translates it into a sequence of skills.
