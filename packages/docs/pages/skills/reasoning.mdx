...
1. [Reasoning](/skills/reasoning): Smart agents with reasoning capabilities.
2. [Fine Tuning](/skills/fine-tuning): Bot can handle fine tuned responses.
3. [Processing](/skills/processing): Bot can handle multiple responses from the AI.
4. [Parsing](/skills/parsing): Bot interprets user intent and translates it into a sequence of skills.
5. [Skill definition](/skills/structure): First, we define our bot's available skills.
