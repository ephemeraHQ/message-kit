...
- [Subscribe](/use-cases/agent/subscribe): Integrate with Redis db to store the subscription status
- [Broadcast](/use-cases/agent/broadcast): Integrate with Cron to send the subscription message every day

## Structure

> Check out the [repository](https://github.com/ephemeraHQ/message-kit/tree/main/examples/agent) for the full code.

```
agent/              # Your project's root directory.
├── src/
...
# Go to the examples/agent folder
cd examples/agent
