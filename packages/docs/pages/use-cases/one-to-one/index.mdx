...
- [Redis](/use-cases/one-to-one/subscribe): Integrate with Redis db to store the subscription status
- [Cron](/use-cases/one-to-one/broadcast): Integrate with Cron to send the subscription message every day
