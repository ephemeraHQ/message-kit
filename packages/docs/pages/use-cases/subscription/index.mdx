...
- [Redis](/use-cases/subscription/database): Integrate with Redis db to store the subscription status
- [Cron](/use-cases/subscription/cron): Integrate with Cron to send the subscription message every day

## Structure

> Check out the [repository](https://github.com/xmtp-labs/message-kit/tree/main/examples/subscription) for the full code.

```
subscription/              # Your project's root directory.
├── src/
