...
```bash
Share in Farcaster (Framev2): https://agent-client.message-kit.org/?address=0x...
```
...
Baselinks is a way to generate dynamic urls for your agent. They can work on Browsers or in a frame rendering environment.
