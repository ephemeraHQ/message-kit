...
```
https://web.message-kit.org/?amount=5
```
...
```
https://web.message-kit.org/?recipientAddress=0x742d35Cc6634C0532925a3b844Bc454e4438f44e
```
...
```
https://web.message-kit.org/?recipientAddress=0x742d35Cc6634C0532925a3b844Bc454e4438f44e&tokenAddress=0x833589fcd6edb6e08f4c7c32d4f71b54bda02913&chainId=8453&amount=10
```
...
```bash
https://web.message-kit.org/?chainId=1&tokenAddress=0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48&amount=2
```
...
```bash
https://web.message-kit.org/mint?collectionId=0x73a333cb82862d4f66f0154229755b184fb4f5b0&tokenId=1
```
...
```bash
https://web.message-kit.org/receipt?txLink=https://sepolia.basescan.org/tx/0x2ec524f740c5831b16ca84053f9b6ae3e3923d3399d527113982e884a75e6bfa&networkLogo=https://avatars.githubusercontent.com/u/108554348?s=280&v=4&networkName=Base&tokenName=usdc&amount=1
```
