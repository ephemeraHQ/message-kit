...
import MainComponent from "../../components/MainComponent"; // Assuming there's a MainComponent
...
export default function HomePage({
  ...
  const image = `${params.url}/api/home?txLink=${params.txLink}&amount=${params.amount}&networkId=${params.networkId}`;
    ...
    return (
      <>
        <Head>
          ...
          <meta property="fc:frame:button:1" content={`Home Action`} />
